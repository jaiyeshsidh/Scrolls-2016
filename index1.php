...
<script>$(document).ready(function(){$("#form-member-container-3").hide();$("#team-leader-container-3").hide();$("#form-college-name").hide();$(".form-no-of-participants").click(function(){console.log("hi");if($(this).attr("value")=="2"){$("#form-member-container-3").hide();$("#team-leader-container-3").hide()}if($(this).attr("value")=="3"){$("#form-member-container-3").show();$("#team-leader-container-3").show()}});$("#form-domains").change(function(){$("#form-topics").children().remove();$.get("http://akgec-scrolls.com/rest/api/Domains/GetTopics?domainId="+$(this).val(),function(c,a){for(var b=0;b<c.length;b++){$("#form-topics").append($("<option>",{value:c[b].TopicId,text:c[b].TopicName}))}})});$("#form-college").change(function(){if($(this).val()==""){$("#form-college-name").show()}else{$("#form-college-name").hide()}});$("#form-college").change(function(){if($(this).val()==4){$("#form-studentId").show()}else{$("#form-studentId").hide()}})});</script>
