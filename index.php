...
<div style="z-index: 9999 !important;" id="nav-top">
    ...
    <div class="download">
        <a href="asset/Synopsis.pdf" data-toggle="tooltip" data-placement="bottom" title="Download"><button class="btn"><span class="fa fa-file-text" style="font-size: 25px;  padding"></span></button></a>
