    ...
    <div id=wrapper>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" id=sidebar-wrapper role=navigation>
            <ul class="nav sidebar-nav">
                ...
                <li>
                    <a href="https://www.facebook.com/akgecscrolls16/?fref=ts" type=button class="ham is-closed" data-toggle=offcanvas>Follow us on Facebook</a>
                </li>
            </ul>
        </nav>
...
<section class=landing id=#landing style="background-image:url('asset/images/audi-made-2.jpg');background-size:cover;background-repeat:no-repeat;overflow:hidden">
    <ul id=scene class=scene style=overflow:hidden;z-index:;height:100vh>
        ...
        <li class="layer l3" data-depth=0.00><div class="row text-center"><a href=#about type=button style="text-decoration: none; color:#fff;">Scroll Down<p><span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span><p></a></div></li>
...
<script>$(function(){$.scrollify({section:".landing, .about, .wrapper, .logo-section, .topics, .rules, .team",interstitialSection:"",easing:"easeOutExpo",scrollSpeed:2000,offset:0,scrollbars:false,standardScrollElements:".modal",setHeights:true,overflowScroll:true,})});</script>
