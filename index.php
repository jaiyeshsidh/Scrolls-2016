...
<!--<div id="foo"></div>-->
<!--<script>-->
<!--    loader = document.getElementById('foo');-->
<!---->
<!--</script>-->
<!--  LOADER -->
<!--<div id='loader' class='fd-loader' style='position: fixed; width: 100%; height: 100%; top: 0; left: 0; padding-top:10%; z-index:55550; background: #edb128; text-align: center;'>-->
<!--    <img src="asset/images/podium.png" class="loaderPodium" >-->
<!--    <div class='loader-text' >Have Patience. Site is Loading.</div>-->
<!--</div>-->
...
<div style=z-index:9999!important id=nav-top>
    ...
    <div id=wrapper>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" id=sidebar-wrapper role=navigation>
                ...
                <div id=dates class="panel-collapse drop-date-panel collapse hover-fix">
                    <ul class=list-group>
                        <li class=list-group-item>
                            4th October, 2016
                            <p style=font-size:11px;margin-top:-5px;margin-bottom:0;line-height:12px>Last Date for Registration and Submission of Synopsis</p>
                        </li>
                        <li class=list-group-item>
                            8th October, 2016
                            <p style=font-size:11px;margin-top:-5px;margin-bottom:0;line-height:12px>Notification of Synopsis Selection</p>
                        </li>
                        <li class=list-group-item>
                            18th October, 2016
                            <p style=font-size:11px;margin-top:-5px;margin-bottom:0;line-height:12px>Last Date for Submission of Final Paper.</p>
                        </li>
                        <li class=list-group-item>
                            21st October, 2016
                            <p style=font-size:11px;margin-top:-5px;margin-bottom:0;line-height:12px>Main Event</p>
                        </li>
                    </ul>
                </div>
                <li>
            ...
            <div style="bottom: 18px; margin-left: 22px; position: absolute;" id="findusonfb">
                <a href="https://www.facebook.com/akgecscrolls16/" target="_blank" type=button class="ham is-closed " data-toggle=offcanvas><img src="asset/images/find-us-on-facebook-YELLOW.png" style="width: 50%; height: auto;" id="fb-img"></a>
            </div>
        </nav>
        <div id=page-content-wrapper>
            <button type=button class="hamburger is-closed ham" data-toggle=offcanvas>
    ...
    <div class=custom-register>
        <a data-toggle=modal data-target=#form-modal><button class=btn><span class=custom-register-text>Register Here</span><span class="fa fa-user" id=display-pc style="font-size:30px;padding:10px 3%;vertical-align:middle"></span></button></a>
    </div>
...
<section class=about id=about>
    <div class=container>
        <div class=row>
            <div class=col-lg-12>
                <h1>About Scrolls</h1>
                <h4>“ Logic will take you from A to B but imagination will take you everywhere.”<br>- Albert Einstein</h4>
...
<section class=topics id=topics>
    <div class="container-fluid gap-off display-web">
        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-6 gap-off nav nav-pills">
        ...
        <div class="modal fade" id=ec role=dialog>
            <div class=modal-dialog>
                <div class=modal-content>
                    <div class=modal-header>
                        <button type=button class=close data-dismiss=modal>&times;</button>
                        <h4 class=modal-title>Electronics and Communication</h4>
                    </div>
                    <div class="modal-body gap-off" style=padding:10px!important>
                        <div class="container-fluid gap-off">
                            <ol class=modal-list>
        ...
        <div class="modal fade" id=ce role=dialog>
            <div class=modal-dialog>
                <div class=modal-content>
                    <div class=modal-header>
                        <button type=button class=close data-dismiss=modal>&times;</button>
                        <h4 class=modal-title>Civil Engineering</h4>
                    </div>
                    <div class="modal-body gap-off" style=padding:10px!important>
                        <div class="container-fluid gap-off">
                            <ol class=modal-list>
        ...
        <div class="modal fade" id=ms role=dialog>
            <div class=modal-dialog>
                <div class=modal-content>
                    <div class=modal-header>
                        <button type=button class=close data-dismiss=modal>&times;</button>
                        <h4 class=modal-title>Management Science</h4>
                    </div>
                    <div class="modal-body gap-off" style=padding:10px!important>
                        <div class="container-fluid gap-off">
                            <ol class=modal-list>
...
<section class=team id=contact>
    <div class="conatiner-fluid gap-off">
        <div class="row row-off">
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 gap-off">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 gap-off">
                <a href=http://www.silive.in target="_blank" id=anchorsi><div class="col-sm-12 poweredbysi">
                        ...
                        <h1 style=text-transform:uppercase;margin:0;font-size:19px;>Software Incubator</h1>
    ...
    <div class=modal-dialog>
        <div class="modal-content modal-content-query">
            ...
            <div class=modal-body>
                <form action="RegisterQuery.php" method=POST id="query-form">
...
<div class="modal fade" id=scroll-team role=dialog>
    <div class=modal-dialog>
        <div class=modal-content style=background-color:rgba(0,0,0,0.0)>
            ...
            <div class="modal-body gap-off" style=padding:0!important>
                <div class="container-fluid gap-off">
                    <div class="row row-off">
                        <div class="col-sm-6 col-sm-offset-3 gap-off">
                            <img src=asset/images/t.jpg class="img-responsive center-block">
                            <p class=web-team-name>Prof. V. K. PARASHAR <span style=display:block;font-size:10px>Dean Student Welfare, AKGEC</span></p>
                        </div>
                    </div>
                    <div class="row row-off">
...
<div class="modal fade" id=dev-team role=dialog>
    <div class=modal-dialog>
        <div class=modal-content style=background-color:rgba(0,0,0,0.0)>
            <div class=modal-header style=background-color:rgba(0,0,0,0.0)>
                <button type=button class=close data-dismiss=modal>&times;</button>
                <h4 class="modal-title text-center">Software Incubator Team</h4>
            </div>
                ...
                <div class="container-fluid gap-off">
                    <div class=row>
                        ...
                        <div class="col-lg-3 col-sm-3 col-xs-3 gap-off">
                            ...
                            <p class=web-team-name>Sukankshi Jain</p>
                        </div>
                    </div>
                    <div class=row>
                        <div class="col-lg-3 col-sm-3 col-xs-3 gap-off">
                            <img src=asset/images/dt4.jpg class=img-responsive>
                    ...
                    <div class=row>
                        <div class="col-lg-3 col-sm-3 col-xs-3 gap-off col-sm-offset-1 col-xs-offset-1">
                            <img src=asset/images/dt8.jpg class=img-responsive>
                            <p class=web-team-name>Akash Kool</p>
                        </div>
                        <div class="col-lg-3 col-sm-3 col-xs-3 gap-off">
                            <img src=asset/images/dt9.jpg class=img-responsive>
                            <p class=web-team-name>Abhishek Kumar Gupta</p>
                        </div>
                        <div class="col-lg-3 col-sm-3 col-xs-3 gap-off">
                            <img src=asset/images/dt10.jpg class=img-responsive>
                            <p class=web-team-name>Akriti Verma</p>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id=form-modal tabindex=-1 role=dialog aria-labelledby=myModalLabel aria-hidden=true style=padding-left:0>
...
<div class="modal fade" id=form-modal-login tabindex=-1 role=dialog aria-labelledby=mySmallModalLabel aria-hidden=true>
    <div class=modal-dialog>
        <div class=modal-content>
            <div class=modal-header>
                <button type=button class=close data-dismiss=modal aria-label=Close>
...
<script>$(document).ready(function(){$("div.bhoechie-tab-menu>div.list-group>a").click(function(b){b.preventDefault();$(this).siblings("a.active").removeClass("active");$(this).addClass("active");var a=$(this).index();$("div.bhoechie-tab>div.bhoechie-tab-content").removeClass("active");$("div.bhoechie-tab>div.bhoechie-tab-content").eq(a).addClass("active")})});</script>
