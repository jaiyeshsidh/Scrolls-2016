...
<div style=z-index:9999!important id=nav-top>
    ...
    <div class=custom-register>
        <a data-toggle=modal ><button class=btn disabled><span class=custom-register-text>Register Here</span><span class="fa fa-user" id=display-pc style="font-size:30px;padding:10px 3%;vertical-align:middle"></span></button></a>
    </div>
